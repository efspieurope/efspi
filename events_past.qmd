...
Below a list of past events organized by [EFSPI](http://www.efspi.org) and/or its National Organisations, with links to related materials like slide decks (where available).

In case of any questions please contact [efspieurope@gmail.com](efspieurope@gmail.com).

```{r echo = FALSE, message = FALSE, warning = FALSE, include = FALSE}
# how to do this with child documents: https://gist.github.com/rmoff/a043676a2f084b81a434
ut <- unique(events$Type)

out1 <- NULL
#for (j in 1:length(ut)){
    out1 <- c(out1, knit_expand('tools/events.qmd'))
#}
